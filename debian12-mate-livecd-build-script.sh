...
cp desktop-shortcuts.sh $PATH1/LIVE_BOOT/chroot/tmp/desktop-shortcuts.sh
...
# Make desktop shortcuts script run on terminal startup
cp /tmp/desktop-shortcuts.sh /home/debian12live/desktop-shortcuts.sh
chown debian12live /home/debian12live/desktop-shortcuts.sh && chmod +x /home/debian12live/desktop-shortcuts.sh
cat <<'EOF' >> /home/debian12live/.bashrc
if ! [[ -e /home/debian12live/Desktop/*.desktop ]]; then
	/home/debian12live/desktop-shortcuts.sh
else
	:
fi
EOF
